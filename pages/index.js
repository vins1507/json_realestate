...
export default function Home({ propertiesForSale, propertiesForRent }) {
  ...
  return (
    ...
    />
      <Flex flexWrap="wrap">
{propertiesForRent.map((propertyItem)=><Property property={propertyItem} Key={propertyItem.id}/>)}
      ...
      />
    <Flex flexWrap="wrap">
    {propertiesForSale.map((propertyItem)=><Property property={propertyItem} key={propertyItem.id}/>)}
</Flex>
